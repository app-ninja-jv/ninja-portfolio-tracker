...
<p><code>pip install equity-tracker[live]</code> &middot;
...
<p>Source: <a href="https://github.com/jovi-maverick/equity-tracker">github.com/jovi-maverick/equity-tracker</a>
